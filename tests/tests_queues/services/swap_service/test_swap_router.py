...
class TestSwapRouter:
    async def test_swap_router_request_action(self, mock_update, mock_context, mock_ctx, sample_queue):
    ...
    async def test_swap_router_accept_action(self, mock_update, mock_context, mock_ctx, sample_queue):
        ...
        with (
            ...
            mock_queue_service.update_queue_message.assert_awaited_once_with(mock_context, mock_ctx)

            # Проверяем удаление сообщения
            mock_context.bot.delete_message.assert_awaited_once_with(chat_id=999, message_id=555)

    async def test_swap_router_decline_action(self, mock_update, mock_context, mock_ctx, sample_queue):
    ...
    async def test_swap_router_no_target(self, mock_update, mock_context, mock_ctx, sample_queue):
    ...
    async def test_swap_router_unknown_action(self, mock_update, mock_context, mock_ctx, sample_queue):
    ...
    async def test_swap_router_request_update_queue_message_not_called(
        ...
        with (
            ...
            mock_queue_service.update_queue_message.assert_not_awaited()

    async def test_swap_router_accept_deletes_message_on_true(self, mock_update, mock_context, mock_ctx, sample_queue):
    ...
    async def test_swap_router_multiple_args(self, mock_update, mock_context, mock_ctx, sample_queue):
    ...
    async def test_swap_router_decline_with_return_none(self, mock_update, mock_context, mock_ctx, sample_queue):
