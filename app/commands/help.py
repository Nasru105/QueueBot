...
class CommandHelp:
    ...
    COMMANDS: Dict[str, Dict] = {
        ...
        "set_update_count": {
            ...
            "usage": "/set_update_count [Очередь] [-m минуты] [-c количество сообщений]",
            "details": (
                "Устанавливает автоматическое обновление очереди через указанное количество сообщений и минут.",
                "Без параметра [Очередь] для установки для всех очередей",
                "Без параметра [-m минуты] для сброса обновления по времени",
                "Без параметра [-c количество сообщений] для сброса обновления по сообщения",
            ),
            "admin": True,
            "category": "Администрирование",
        },
